...
$pdf->Cell(38, 8, "E-mail", 1, 0, ‘L’);

$pdf->Cell(65, 8, "Contato (ID na agenda)", 1, 1, ‘L’);

//EXIBE OS REGISTROS 
for($i=$inicio; $i<$fim; $i++) {
$pdf->Cell(15, 8, mysql_result($sql, $i, "id"),
1, 0, ‘C’); 
$pdf->Cell(38, 8, mysql_result($sql, $i, "email"),
1, 0, ‘L’); 
$pdf->Cell(65, 8, mysql_result($sql, $i, "idcontato"),
1, 1, ‘L’); 
$linha_atual++;
