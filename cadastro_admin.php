...
$query_select = "SELECT Username FROM Admins WHERE Username = '$username'";
    ...
    if(($username == "" || $username == null) || ($nome == "" || $nome == null) || ($sobrenome == "" || $sobrenome == null) || ($senha == MD5("") || $senha == null)){
        ...
        window.location.href='cadastro_admin.html';
            ...
            if($logarray == $username){
                ...
                $query_insert = "INSERT INTO Admins (Nome,Sobrenome,Username,Senha) VALUES ('$nome','$sobrenome','$username','$senha')";
                ...
                if($insert){
                    ...
                    window.location.href='lista_admins.php'
                    </script>";
